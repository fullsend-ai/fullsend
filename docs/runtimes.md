...
| `extensions` | Unsupported — warned and skipped | ✓ uploaded to `PI_CODING_AGENT_DIR/extensions/`, tree-hash preflight, loaded with `-e` ([Extensions](runtimes/pi.md#extensions), ADR 0094) | Unsupported — warned and skipped |
