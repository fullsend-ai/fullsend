...
- PR #6009 is superseded by this decision; it should be closed rather than rebased, and reopened against the versioned schema if still wanted.
- #5568 is resolved by this decision.
