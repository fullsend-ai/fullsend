...
- What's the right balance between CLAUDE.md (always-loaded) and BOOKMARKS.md (on-demand)? How do agents know to check BOOKMARKS.md for a given task? (Harness skill load mode — Skill-tool on-demand vs `apply: always` paste into the agent definition — is decided in [ADR 0091](../ADRs/0091-always-on-harness-skills.md). CLAUDE.md vs BOOKMARKS.md balance remains open.)
