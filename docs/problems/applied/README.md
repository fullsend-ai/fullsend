...
- **[agent-eval-tools](agent-eval-tools/)** — Agent setup evaluation tools. How fullsend's problem areas appear in tools that lint and security-scan agent configurations.
