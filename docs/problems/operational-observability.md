...
- ~~What retention policy applies to traces? Indefinite retention supports audit requirements but increases storage cost and data sensitivity exposure. Time-bounded retention (e.g., 90 days) limits exposure but may lose traces needed for incident investigation.~~ Decided in [ADR 0109](../ADRs/0109-trace-retention-policy.md): administrator-tunable defaults per artifact category (metadata 180 days, content 30 days, JSONL 90 days, eval scores 365 days), enforced at the storage layer.
