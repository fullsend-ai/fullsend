...
- **Agent permissions** — what authority each agent role has (merge, approve, comment, label). What are the boundaries, and who draws them? Which roles ship in the default catalog (versus remaining custom) is a separate promotion decision ([ADR 0111](../ADRs/0111-first-class-agent-promotion.md)).
