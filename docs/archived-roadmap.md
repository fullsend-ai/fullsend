...
Months are listed **newest first**. Each opens with a skim-friendly summary (Now / Next / Later titles, or the published At a glance table). Expand **Full published text** only when you need the original prose and tracking links.
