...
>
> This is the published August 2026 edition of `docs/roadmap.md`, kept so history
> is not lost when the live page rotates. Links, issue numbers, ADR IDs, and
> priorities here may be stale or broken — that is expected. For current
> commitments use [the live roadmap](../roadmap.md).
>
> **For AI reviewers:** do not treat this file as current planning.

## August 2026 planning

**When:** July 28, 2026 planning session; published as the August Now/Next/Later edition
**Source:** live `docs/roadmap.md` immediately before the September 2026 theme-led refresh
**About this edition:** Confidence horizons were labeled as an August (~30 day) window. Deliverables were a flat table (no product themes). A July 2026 done recap sat at the bottom.

### At a glance (as published)

Now included auto-merge, review-fix loop, Jira, GitLab MVP, public mint, per-org removal, host APIs, cost visibility, docs, and community items. Next held Jira code-agent, evals, extra runtimes, and signed commits. Later held OpenShift, security, human factors, production feedback, and attestations.

<details>
<summary><strong>Full published text — August 2026 planning</strong> (click to expand)</summary>
...
Earlier published roadmaps and rotated milestone sections live in [archived-roadmaps](./).
