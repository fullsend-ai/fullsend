...
- [Rollout order](#rollout-order) — what must hold before the default reaches a stage
...
The runner exports `FULLSEND_STEER_ACTIVE=1` into the sandbox for an iteration whose watcher
