...
|-------|--------|---------------|--------------------------|
| `fullsend-sandbox` | triage, prioritize, retro | High (most agent runs) | Claude Code, pi (pinned; opt-in runtime, #6464), jq, gitleaks, acli, pre-commit, gitlint, tirith, ProtectAI DeBERTa model |
