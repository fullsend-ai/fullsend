...
help:
	...
	@echo "  script-test          - Run shell script tests (reconcile-repos, topissues, analyze-transcript, user-forum-whats-new, gitlint-rules, lint-adr-frontmatter, artifact redaction, kill_stray_processes)"
...
script-test:
	...
	$(call run-timed,python3 hack/lint_adr_frontmatter_test.py)
