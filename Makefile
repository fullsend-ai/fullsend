...
lint-md-links:
	lychee --offline --no-progress --include-fragments --exclude-path node_modules --exclude-path experiments --exclude-path docs/archived-roadmap.md --exclude-path docs/archived-roadmaps '**/*.md'
