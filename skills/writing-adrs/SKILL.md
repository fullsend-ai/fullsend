...
6. **Run linters.** Execute `make lint-all` and fix any errors before committing.
...
- You didn't run `make lint-all` -- stop and run it
...
| Skipping linters | Run `make lint-all` before committing |
