...
- **[docs/scribe-agent.md](docs/scribe-agent.md)** — Scribe agent: automated meeting notes → GitHub issue backlog (renamed from secretarial agent per [#222](https://github.com/fullsend-ai/fullsend/issues/222))
