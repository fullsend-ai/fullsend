...
- If your change touches a problem doc, make sure the "Open questions" section still makes sense after your edit. Authoring rules (options with trade-offs, organization-agnostic core, bidirectional backlinks) are in [Problem Documents](docs/contributing/problem-docs.md).
