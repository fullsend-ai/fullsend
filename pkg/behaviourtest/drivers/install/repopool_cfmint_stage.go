...
//
// The org parameter is accepted for Factory signature compatibility
// but is ignored — the driver always uses StageOrg ("halfsend").
...
func buildStageMintDriver(
	...
	return newComposedDriver(StageOrg, md, ens, poolSize, logf)
}
...
// Exported so unit tests can verify arg construction.
