...
// testCFAccessEnv holds the test infrastructure for CF Access JWT
// validation tests.
type testCFAccessEnv struct {
	key     *rsa.PrivateKey
	kid     string
	team    string
	aud     string
...
func newTestCFAccessEnv(t *testing.T) *testCFAccessEnv {
	t.Helper()
...
func (e *testCFAccessEnv) signCFAccessToken(t *testing.T, overrides map[string]any) string {
	t.Helper()
