...
//go:embed mintsrc/go.mod.embed mintsrc/go.sum.embed mintsrc/main.go.embed mintsrc/mintcore/go.mod.embed mintsrc/mintcore/go.sum.embed mintsrc/mintcore/claims.go.embed mintsrc/mintcore/config.go.embed mintsrc/mintcore/doer.go.embed mintsrc/mintcore/doer_http.go.embed mintsrc/mintcore/foreign.go.embed mintsrc/mintcore/gcp_pem.go.embed mintsrc/mintcore/github.go.embed mintsrc/mintcore/github_crypto.go.embed mintsrc/mintcore/handler.go.embed mintsrc/mintcore/handler_http.go.embed mintsrc/mintcore/interfaces.go.embed mintsrc/mintcore/jwt_parse.go.embed mintsrc/mintcore/jwks_verifier.go.embed mintsrc/mintcore/patterns.go.embed mintsrc/mintcore/repos_scope.go.embed mintsrc/mintcore/sts_verifier.go.embed mintsrc/mintcore/version.go.embed mintsrc/mintcore/wif.go.embed
...
var embeddedMintFiles = map[string]string{
	...
	"mintcore/doer.go.embed":          "mintcore/doer.go",
	"mintcore/doer_http.go.embed":     "mintcore/doer_http.go",
	...
	"mintcore/github_crypto.go.embed": "mintcore/github_crypto.go",
	"mintcore/handler.go.embed":       "mintcore/handler.go",
	"mintcore/handler_http.go.embed":  "mintcore/handler_http.go",
	"mintcore/interfaces.go.embed":    "mintcore/interfaces.go",
	"mintcore/jwt_parse.go.embed":     "mintcore/jwt_parse.go",
