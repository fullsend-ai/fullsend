...
//
// Optional auth modes ("github" and "cfaccess") are build-time selected
// via Go build tags. When a mode is not enabled, its stub (returning
// errStatusAuthSkip) is compiled in instead, keeping unused dependencies
// out of the binary.
