...
'inference provision' and 'mint enroll' before running this command.`,
	...
	cmd.Flags().BoolVar(&opts.gitlabRoleRollbackConfirmed, "gitlab-role-rollback-confirmed", false, "confirm reopening the shared GitLab credential path when changing an enforced role gate to rollback")
