...
// in-progress job is me; when several are in progress the hints decide. An
// unresolvable job name fails closed — no steering at all beats steering on
// another stage's authorization.
